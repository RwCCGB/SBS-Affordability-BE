...
export const affordabilityRequestSchema = z.object({
  ...
  /*TODO: remove this. I put it here merely to demonstrate that you do do conditional validation on combinations of fields*/
  (data) => (data.repaymentType === 'Interest Only' && data.region === 'Yorkshire & Humberside'), {
    message: "Interest Only available to residents of Yorkshire & Humberside only",
    path: ["checkRegion"],
});
